...
export class VisitonComponent implements OnInit {
  ...
  dropdownSettings = {};
   ...
   isRowSelect= false;
    ...
    isButton = false;
  constructor(private router:Router,private visitonsrv:VictorServiceService) {
    ...
    this.visitonsrv.getOtherLeads(
     ...
     this.visitonsrv.get_leads_count_company(localStorage.getItem('user_name')).subscribe((data: UserLeads)=>{
       console.log(data);

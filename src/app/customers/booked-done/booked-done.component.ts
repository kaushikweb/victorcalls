...
export class BookedDoneComponent implements OnInit {
  ...
  dropdownSettings = {};
   ...
   isRowSelect= false;
    ...
    isButton = false;
  constructor(private router:Router, private bookedsrv:VictorServiceService,) { 
     ...
     this.bookedsrv.getOtherLeads(
      ...
      this.bookedsrv.get_leads_count_company(localStorage.getItem('user_name')).subscribe((data: UserLeads)=>{
        console.log(data);

...
export class ResaleComponent implements OnInit {
  ...
  dropdownSettings = {};
   ...
   isRowSelect= false;
    ...
    isButton = false;
  constructor(private router: Router, private reslaesrv: VictorServiceService,
    private bsmodalservice: BsModalService) {
      ...
      this.reslaesrv.getOtherLeads(
       ...
       this.reslaesrv.get_leads_count_company(localStorage.getItem('user_name')).subscribe((data: UserLeads)=>{
        console.log(data);

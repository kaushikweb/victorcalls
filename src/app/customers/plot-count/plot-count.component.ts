...
export class PlotCountComponent implements OnInit {
  ...
  dropdownSettings = {};
   ...
   isRowSelect= false;
    ...
    isButton = false;
  constructor(private rouuter:Router,private plotcountsrv:VictorServiceService) {
    ...
    this.newlist = [];
     ...
     this.loading= true;
     this.plotcountsrv.getOtherLeads(
      ...
      this.plotcountsrv.get_leads_count_company(localStorage.getItem('user_name')).subscribe((data: UserLeads)=>{
        console.log(data);

...
export class OtherProjectsComponent implements OnInit {
  ...
  constructor(private router: Router,private otherprojsrv: VictorServiceService) {
    ...
    this.newlist = [];
     ...
     this.loading= true;
     this.otherprojsrv.getOtherLeads(
      ...
      this.otherprojsrv.get_leads_count_company(localStorage.getItem('user_name')).subscribe((data: UserLeads)=>{
        console.log(data);

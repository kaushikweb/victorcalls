...
export class NoworkComponent implements OnInit {
  ...
  dropdownSettings = {};
   ...
   isRowSelect= false;
    ...
    isButton = false;
  constructor(private router:Router, private noworksrv:VictorServiceService) {
    ...
    this.newlist = [];
     ...
     this.noworksrv.getOtherLeads(
      ...
      this.noworksrv.get_leads_count_company(localStorage.getItem('user_name')).subscribe((data: UserLeads)=>{
        console.log(data);

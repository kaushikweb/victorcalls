...
export class RentCountComponent implements OnInit {
  ...
  constructor(private router:Router,private rentcountsrv:VictorServiceService) {
    this.newlist = [];
     ...
     this.loading= true;
     this.rentcountsrv.getOtherLeads(
      ...
      this.rentcountsrv.get_leads_count_company(localStorage.getItem('user_name')).subscribe((data: UserLeads)=>{
        console.log(data);

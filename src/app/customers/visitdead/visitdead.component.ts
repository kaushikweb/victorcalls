...
export class VisitdeadComponent implements OnInit {
  ...
  dropdownSettings = {};
   ...
   isRowSelect= false;
    ...
    isButton = false;
  constructor(private router:Router, private visitdeadsrv:VictorServiceService) { 
    ...
    this.loading= true;
    this.visitdeadsrv.getOtherLeads(
     ...
     this.visitdeadsrv.get_leads_count_company(localStorage.getItem('user_name')).subscribe((data: UserLeads)=>{
       console.log(data);

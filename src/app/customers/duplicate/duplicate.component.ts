...
export class DuplicateComponent implements OnInit {
  ...
  dropdownSettings = {};
   ...
   isRowSelect= false;
    ...
    isButton = false;
  constructor(private router:Router,private duplicatesrv:VictorServiceService) {
    ...
    this.newlist = [];
     ...
     this.loading= true;
     this.duplicatesrv.getOtherLeads(
      ...
      this.duplicatesrv.get_leads_count_company(localStorage.getItem('user_name')).subscribe((data: UserLeads)=>{
        console.log(data);

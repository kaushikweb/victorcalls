...
export class DeadCountComponent implements OnInit {
  ...
  dropdownSettings = {};
   ...
   isRowSelect= false;
    ...
    isButton = false;
  constructor(private router:Router,private deadcountsrv:VictorServiceService) {
    this.newlist = [];
     ...
     this.loading= true;
     this.deadcountsrv.getOtherLeads(
      ...
      this.deadcountsrv.get_leads_count_company(localStorage.getItem('user_name')).subscribe((data: UserLeads)=>{
        console.log(data);

...
export class FollowupComponent implements OnInit {
  ...
  dropdownSettings = {};
   ...
   isRowSelect= false;
    ...
    isButton = false;
  constructor(private router: Router, private followupsrv: VictorServiceService,
    private bsmodalservice: BsModalService) { 
      ...
      this.loading= true;
     this.followupsrv.getOtherLeads(
      ...
      this.followupsrv.get_leads_count_company(localStorage.getItem('user_name')).subscribe((data: UserLeads)=>{
        console.log(data);
